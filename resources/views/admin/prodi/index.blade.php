                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item active">/ Prodi
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="alert alert-danger" role="alert">
                    Pastikan sebelum menghapus data Prodi, data Semua PESERTA dengan tipe yang sama juga sudah dihapus !
                </div>
                <div class="row">
                    <div class="col-12">
                ...
                <div class="alert alert-light" role="alert">
                    <div>Contoh Warna</div>
                    <table class="ml-2">
                        @foreach (Helper::getEnumValues('prodi', 'warna') as $item)
                            <tr>
                                <td>
                                    {{ $item }}
                                </td>
                                <td>
                                    : <span class="badge badge-{{ $item }}">{{ Helper::getColorCode($item) }}</span>
                                </td>
                            </tr>
                        @endforeach
                    </table>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2bs4 w-100" name="warna" required>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="warna">Warna</label>
                                <select class="form-control select2bs4 w-100" name="warna" id="warna" required>
                                    <option value="">Pilih Warna</option>
                                    @foreach (Helper::getEnumValues('prodi', 'warna') as $item)
                                        <option value="{{ $item }}">{{ $item }}</option>
                                    @endforeach
...
@push('script')
    ...
    <script>
        ...
        $('#modal_edit').on('show.bs.modal', function(event) {
            ...
            modal.find('#warna').val(warna).change();
        ...
        $('#form_edit').submit(function(e) {
            ...
            var url = "{{ route('admin.prodi.edit') }}";
    ...
    <script>
        ...
        function dataTable(id) {
            var url = "{{ route('admin.prodi.data') }}"
