...
class MahasiswaPasca
{
    ...
    public static function all($offset = null, $limit = null, $search = null, $order = null, $dir = null, $where = null)
    {
        ...
        $apiKey = config('simkeu.simkeu_pasca_api_key');
        $url = config('simkeu.simkeu_pasca_url') . "mahasiswa";
        $ch = curl_init($url);
    ...
    public static function find($id)
    {
        ...
        $apiKey = config('simkeu.simkeu_pasca_api_key');
        $url = config('simkeu.simkeu_pasca_url') . "mahasiswa/id";
        $ch = curl_init($url);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($ch, CURLOPT_POSTFIELDS, $post);
        curl_setopt($ch, CURLOPT_HTTPHEADER, [
    ...
    public static function nim($nim)
    {
        ...
        $apiKey = config('simkeu.simkeu_pasca_api_key');
        $url = config('simkeu.simkeu_pasca_url') . "mahasiswa/nim";
        $ch = curl_init($url);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($ch, CURLOPT_POSTFIELDS, $post);
        curl_setopt($ch, CURLOPT_HTTPHEADER, [
    ...
    public static function count($offset = null, $limit = null, $search = null, $order = null, $dir = null, $where = null)
    {
        ...
        $apiKey = config('simkeu.simkeu_pasca_api_key');
        $url = config('simkeu.simkeu_pasca_url') . "mahasiswa/count";
        $ch = curl_init($url);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($ch, CURLOPT_POSTFIELDS, $post);
        curl_setopt($ch, CURLOPT_HTTPHEADER, [
    ...
    public static function kkn($offset = null, $limit = null, $search = null, $order = null, $dir = null, $where = null)
    {
        ...
        $apiKey = config('simkeu.simkeu_pasca_api_key');
        $url = config('simkeu.simkeu_pasca_url') . "mahasiswa/kkn";
        $ch = curl_init($url);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($ch, CURLOPT_POSTFIELDS, $post);
        curl_setopt($ch, CURLOPT_HTTPHEADER, [
